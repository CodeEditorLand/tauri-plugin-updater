...
pub enum Error {
	...
	#[error(
		"Unsupported application architecture, expected one of `x86`, `x86_64`, `arm` or \
		 `aarch64`."
	)]
	UnsupportedArch,
	...
	#[error(
		"The signature {0} could not be decoded, please check if it is a valid base64 string. The \
		 signature must be the contents of the `.sig` file generated by the Tauri bundler, as a \
		 string."
	)]
